 ...
 */
export declare function setRivetContext<Registry extends AnyActorRegistry>(rivet: RivetKit<Registry>): RivetKit<Registry>;
/**
 ...
 */
export declare function getRivetContext<Registry extends AnyActorRegistry>(): RivetKit<Registry>;
/**
 ...
 */
export declare function hasRivetContext(): boolean;
/**
 ...
 * ```
 */
export declare function setupRivetKit<Registry extends AnyActorRegistry>(clientInput?: Parameters<typeof createClient<Registry>>[0], opts?: CreateRivetKitOptions<Registry>): RivetKit<Registry>;
/**
 ...
 * ```
 */
export declare function setupRivetKitWithClient<Registry extends AnyActorRegistry>(client: Client<Registry>, opts?: CreateRivetKitOptions<Registry>): RivetKit<Registry>;
